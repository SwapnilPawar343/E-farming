    ...
    <body>
            ...
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                ...
                <div class="panel panel-default">
                    ...
                    <form action="database/saveuser.php" method="POST" role="form" onsubmit="return user()"enctype="multipart/form-data">
                        ...
                        <button type="submit" name="save" value="save"onsubmit="return user()"class="btn btn-primary">Submit</button>
                    </form>
